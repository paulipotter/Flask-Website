...
def register():
    ...
    return render_template("register.html", info=info, form=form, current_user=current_user)
...
@app.route('/')
def home():
    return render_template("index.html", info=info, current_user=current_user)
...
def blog():
    ...
    return render_template("blog.html", all_posts=posts, info=info, current_user=current_user)


@app.route("/post/<int:post_id>", methods=["GET", "POST"])
def show_post(post_id):
    requested_post = BlogPost.query.get(post_id)
    return render_template("post.html", post=requested_post, info=info, current_user=current_user)
...
def add_new_post():
    ...
    return render_template("make-post.html", form=form, info=info, current_user=current_user)
...
def edit_post(post_id):
    ...
    return render_template("make-post.html", form=edit_form, is_edit=True, info=info, current_user=current_user)
